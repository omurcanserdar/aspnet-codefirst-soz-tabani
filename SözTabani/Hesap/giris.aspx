...
<head runat="server"> 
    ...
    <link href="../bootstrap-3.3.7-dist/css/mystyle.css" rel="stylesheet" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Password"
                    ...
                    <asp:CheckBox CssClass="checkbox-inline" ID="cbxbenihatirla" runat="server" Text="Beni Hatırla" />
                <a href="/sifremiunuttum" class="btn btn-danger btn-xs">Şifremi Unuttum</a>
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-2">
                ...
                <asp:LinkButton ID="BtnLogin" runat="server" ForeColor="White"
                    CssClass="btn btn-danger" OnClick="BtnLogin_Click1" CausesValidation="False">
