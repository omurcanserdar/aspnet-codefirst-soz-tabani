...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
   <asp:LinkButton runat="server" OnClick="Unnamed_Click" CssClass="btn btn-success" CausesValidation="False"><span class="glyphicon glyphicon-repeat" ></span> yenile </asp:LinkButton><br />
                    ...
                    <div class="caption">
                        <h4 class="sozrenk">
                           ...
                           <a href='/s/<%#SözTabani.Helper.HelperMethod.KarakterDuzelt(Eval("soz_icerik").ToString())%>?id=<%#Eval("soz_id") %>' 
                               class="btn btn-info">
                               <span class="glyphicon glyphicon-folder-open"></span> UserDty 
                           </a>
                         ...
                         <a id="silbtn" href='SozSil.aspx?id=<%#Eval("soz_id") %>'class="btn btn-danger">  
